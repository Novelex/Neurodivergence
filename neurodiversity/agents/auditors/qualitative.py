...
Ingest, one call per field per paper. 7 fields (working spec §5.3), including community
involvement in design — a methodological-quality field here, not an editorial add-on.
"""
...
SYSTEM_PROMPT_TEMPLATE = """You check whether a qualitative research paper's full text reports one
